      ...
      if(entree && entree2)
          ...
          case 1:
               {if(j1.verif(0))
                    ...
                    cout <<"a)Diderot b)Voltaire c)Montaigne d)Etienne de la Boetie"<<endl;
                    setcolor(WHITE);
         ...
         switch(x)
          ...
          case 1://jocker switch
               ...
               {case 97:
                  if(j1.verif(0))
                    {j1.settabjocker(0);
                    setcolor(DARK_YELLOW);cout<<"De l oeuvre de quel ecrivain est tiree la celebre question ' Que sais je ? ' "
                    <<"a)Diderot b)Voltaire c)Montaigne d)Etienne de la Boetie"<<endl;setcolor(WHITE);
                ...
                case 112:
                  if(j2.verif(0))
                    ...
                    setcolor(DARK_YELLOW);cout<<"Ou est ne Mozart ? a)Venise b)Turin c)Vienne d)Salzbourg"<<endl;setcolor(WHITE);
